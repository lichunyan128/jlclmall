! function(e) {
	...
	(function() {
		...
		function h(e, t, n, r, i) {
			var o, a, s, c, u, l, f = e.getUint16(t + 2, !i),
				h = e.getUint32(t + 4, !i),
	...
	! function() {
		...
		u.prototype.render = function(e, t, n) {
			...
			var i = this.srcImage,
				...
				d = t.maxWidth,
				g = t.maxHeight,
				m = this.blob && "image/jpeg" === this.blob.type || 0 === o.indexOf("data:image/jpeg") || o.indexOf(".jpg") === c - 4 || o.indexOf(".jpeg") === c - 5;
	...
	function n(e) {
		function t(e) {
			...
			for(var s = [1, 1.387039845, 1.306562965, 1.175875602, 1, .785694958, .5411961, .275899379], c = 0, u = 0; 8 > u; u++)
				for(var l = 0; 8 > l; l++) C[c] = 1 / (U[N[c]] * s[u] * s[l] * 8), T[c] = 1 / (D[N[c]] * s[u] * s[l] * 8), c++
		}
		...
		function i() {
			for(var e = 1, t = 2, n = 1; 15 >= n; n++) {
				for(var r = e; t > r; r++) L[32767 + r] = n, x[32767 + r] = [], x[32767 + r][1] = n, x[32767 + r][0] = r;
				for(var i = -(t - 1); - e >= i; i++) L[32767 + i] = n, x[32767 + i] = [], x[32767 + i][1] = n, x[32767 + i][0] = t - 1 + i;
				e <<= 1, t <<= 1
			}
		}
		...
		function u(e, t) {
			...
			for(l = 0; h > l; ++l) {
				...
				var C = .382683433 * (I - U),
					...
					A = m + L,
					G = m - L;
				e[f + 5] = G + T, e[f + 3] = G - T, e[f + 1] = A + x, e[f + 7] = A - x, f += 8
			}
			for(f = 0, l = 0; h > l; ++l) {
		...
		function m(e, t, n, r, i) {
			...
			var m = A[0] - n;
			n = A[0], 0 == m ? a(r[0]) : (o = 32767 + m, a(r[L[o]]), a(x[o]));
			...
			for(var w, v = 1; p >= v;) {
				...
				o = 32767 + A[v], a(i[(S << 4) + L[o]]), a(x[o]), v++
			}
			return p != f && a(s), n
		}
		...
		var y, S, b, I, P, F = (Math.round, Math.floor),
			U = new Array(64),
			D = new Array(64),
			C = new Array(64),
			T = new Array(64),
		...
		this.encode = function(e, t, n) {
			...
			for(var u, p, v, P, F, U, D, x, L, R = e.data, A = e.width, j = e.height, N = 4 * A, W = 0; j > W;) {
				for(u = 0; N > u;) {
					for(F = N * W + u, U = F, D = -1, x = 0, L = 0; 64 > L; L++) x = L >> 3, D = 4 * (7 & L), U = F + x * N + D, W + x >= j && (U -= N * (W + 1 + x - j)), u + D >= N && (U -= u + D - N + 4), p = R[U++], v = R[U++], P = R[U++], E[L] = (B[p] + B[v + 256 >> 0] + B[P + 512 >> 0] >> 16) - 128, O[L] = (B[p + 768 >> 0] + B[v + 1024 >> 0] + B[P + 1280 >> 0] >> 16) - 128, k[L] = (B[p + 1280 >> 0] + B[v + 1536 >> 0] + B[P + 1792 >> 0] >> 16) - 128;
					i = m(E, C, i, y, b), o = m(O, T, o, S, I), s = m(k, T, s, S, I), u += 32
				}
				W += 8
			}
			if(_ >= 0) {
